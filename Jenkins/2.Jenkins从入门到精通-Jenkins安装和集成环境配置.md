...
![1584604730571](../../1%E7%AC%94%E8%AE%B0/image/1584604730571.png)
...
>
> mv apache-maven-3.6.2/* /opt/maven 移动
...
<tomcat-users>
    ...
    <user username="tomcat" password="tomcat" roles="manage-gui,manage-script,tomcat,admin_gui,admin-script"/>
</tomcat-users>
```
